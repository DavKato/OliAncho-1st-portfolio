export default {
  ...
  desc: {
    portfolio:
      "WEBクリエイターチーム、OliAncho　個性的で直感的なデザイン | 高パフォーマンスなオリジナルサイト/ブログの作成 | その他ウェブに関するご相談受け付けます。",
    blog:
      "WEBクリエイターチームおりあんちょによるブログです。ウェブ、デザイン、デジタルノマド生活、グルテンフリーなどについて書いていきます。"
  },
  // Main preview
  main: {
    about: `WEBクリエイターチームとしてフリーランスで活動しています。\nWEBサイトの制作承ります。`,
    works:
      "今まで作った作品を載せていきます。\nこのポートフォリオも二人の協同作品です。",
    blog:
      "主に仕事、海外生活、料理について書いていきます。\n充実したノマドライフです。",
    location:
      "ノマドワーカーとして海外を転々としています。\n今までに行った国は？\n今いる国は？"
  },
  ...
  emailError: "有効なEメールアドレスを入力してください。",
  titleError: "タイトルを入力してください（なんでもいいですよ！）。",
  messageError: "メッセージは10〜300文字でお願いします。",
  //Form thanks
  thanks: {
    caption: "送信しました！",
    message: "ありがとうございます 😀"
  ...
  about: {
    caption:
      "WEBクリエイターチーム、OliAncho(おりあんちょ)です。\nWEBデザインからコーディングまで一括で承ります。\nもちろん、デザインだけやコーディングだけなど単品も大歓迎！\nお気軽にご連絡ください。",
  ...
  works: {
    ...
    list: [
      ...
      },
      {
        ...
        imageFolder: "lp",
        tech:
          "ウェブデザイン、グラフィックデザイン、コーディング（Svelte/Sapper）、ホスティング、レスポンシブ",
        description:
          "私たちOliAnchoのランディング・ページです。\n\nユーザビリティとクラフト感に拘って制作しました。\n\nデザイン要求に応えながらパフォーマンスを追求するため、Svelte.jsというJSコンパイラを使用しています。",
        url: "https://intro.oliancho.com"
      }
    ]
  },
