    ...
    list: [
      {
        ...
        tech:
          "Site design, Graphic design, Coding (Vue/Nuxt), Multi-Language, Responsive, Translation support",
        description:
      ...
      },
      {
        ...
        imageFolder: "lp",
        tech:
          "Site design、Graphic design、Coding (Svelte/Sapper)、Hosting、Responsive",
        description:
          "Focus for this landing page was:\n\nHand made look/feel,\nGood user experience,\nPerformance without compromising design.\n\nGo check it out and tell us what you think!",
